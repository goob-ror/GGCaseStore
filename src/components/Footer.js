        ...
        <footer>
            ...
            <div>
                <a href="/" class="footer-logo">
                    <img src="${logo}" alt="${logo}" class="logo-image" width="40" height="40"/>
                </a>
            ...
            <div class="footer-section flex-links" style="display: flex; gap: 2.5rem;">
                <div>
                <h2>Quick Links</h2>
                <ul>
                    <li><a href="/">Home</a></li>
            ...
            <div class="footer-section">
                ...
                <li><img src="${facebook}" alt="${facebook}" class="icon"><span>Facebook</span></li>
                <li><img src="${instagram}" alt="${instagram}" class="icon"><span>Instagram</span></li>
                </ul>

                <div class="map-info">
                <h2>Company Address</h2>
                <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
                    <a href="#"><img src="${gmaps}" alt="${gmaps}"></a>
